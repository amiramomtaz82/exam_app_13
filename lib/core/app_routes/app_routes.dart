...
import 'package:exam_app_13/features/exam/presentaion/view/exam_screen.dart';
...
abstract final class AppRoutes {
  static MaterialPageRoute get subjectScreen =>
      MaterialPageRoute(
          builder: (_) =>
              BlocProvider(
                  create: (_) =>
                  getIt<SubjectCubit>()
                    ..doEvents(GetAllSubjectsEvent()),
  ...
  static MaterialPageRoute examScoreScreen(
      int examScore,
      ExamCubit cubit,
      ) {
