...
class _AuthApiClient implements AuthApiClient {
  ...
  Future<HttpResponse<ResetCodeResponse>> RestCode(
    ResetCodeRequest restCodRequest,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(restCodRequest.toJson());
    final _options = _setStreamType<HttpResponse<ResetCodeResponse>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<dynamic>(_options);
    late ResetCodeResponse _value;
    try {
      _value = ResetCodeResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<HttpResponse<ResetPasswordResponse>> resetPassword(
    ResetPasswordRequest restPasswordRequest,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(restPasswordRequest.toJson());
  ...
  @override
  Future<AuthResponseDto> signup(SignupRequestDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<AuthResponseDto> signin(SigninRequestDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
