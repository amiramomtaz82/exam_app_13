...
Widget subjectView(SubjectEntity subject){
  ...
  return Padding(
    ...
    child: Container(height:75,
      ...
      decoration: BoxDecoration(color: colors.white,
          boxShadow: [
        BoxShadow(
      color: colors.darkGrey.withOpacity(0.40),
      blurRadius: 5,
      ...
      child: Row(children: [SizedBox(width: 7,), Image.network(
      subject.icon,
        width: 40,
        height: 40,),SizedBox(width: 10,)
        ,Text(subject.name)
      ],),
    ),
  );
